  ...
  return (
    <ThemeProvider theme={defaultTheme} >
      ...
      <Container disableGutters maxWidth="sm" component="main" sx={{ pt: 8, pb: 6 }}>
        ...
        >
         <h4 className='lay'>
         MEDITATION AND MINDUFULNESS
         </h4>
        </Typography>
        <Typography variant="h4" align="center" color="text.secondary" component="p" style={{color:'black'}}>
      ...
      {tiers.map((tier) => (
          ...
          <Card>
                ...
                <CardActions>
                  <Button fullWidth variant={tier.buttonVariant} onClick={sin2}>
                    {tier.buttonText}
                  </Button>
                </CardActions>
              </Card>
